...
### 1. Таблиця для опису команд (Козуб)
...
### 2. Робота в терміналі (закріплення практичних навичок) (Глядченко)
...
### Відповіді на контрольні запитання (Козуб)
