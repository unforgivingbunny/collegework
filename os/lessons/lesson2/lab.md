...
> Загальний вигляд робочого столу Ubuntu з відкритим меню "Activities". Має бути видно: пошук зверху, панель улюблених додатків (Dash) зліва та віртуальні робочі столи праворуч.

**Способи запуску програм:**

1.  **Через панель швидкого запуску (Dash):** У меню Activities клікнути на іконку термінала на лівій панелі.

Скрін тут

    Іконка термінала (або іншої програми) виділена на панелі Dash.

2.  **Через пошук:** Відкрити Activities, почати вводити назву ("Firefox"), клікнути на іконку в результатах.

Скрін тут

    Рядок пошуку з текстом "firefox" та знайденою програмою.
...
Розгорнуте системне меню з пунктами Switch User, Power Off.
...
тут
    ...
    Головний екран Nothing OS з характерними віджетами (годинник, погода).
